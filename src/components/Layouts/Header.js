...
export default function Header() {
  ...
  return (
    ...
    <MDBNavbar expand='md' className="navbar_custom">
      <MDBContainer fluid>
        <MDBNavbarBrand href='#'><img src={icon} className="icon-header"></img><h3 className="web_name">FRESHBAKES</h3></MDBNavbarBrand>
        ...
        <MDBCollapse navbar show={showBasic}>
          <MDBNavbarNav className='mr-auto mb-2 mb-lg-0'>
           ...
           <div className="sign_in"><MDBIcon far icon="user-circle" size="lg"/></div>
